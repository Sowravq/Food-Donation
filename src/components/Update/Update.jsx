    ...
    return (
        ...
        <p className="text-center text-5xl font-bold">Update Your Food</p>
         ...
         <form  onSubmit={handleUpdateFood}  className="max-w-4xl mx-auto mt-14">
           ...
           <div className="mt-4">
           <button  className="text-gray-900 btn w-full bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 ">Update Now</button>
           </div>
